...
#define STRING_CONFIG_H_AUTHOR "elementalvoid" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Sidewinder X1
    #define DEFAULT_Kp 10.5663
    #define DEFAULT_Ki 0.7120
    #define DEFAULT_Kd 39.2012
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Sidewinder X1
  #define DEFAULT_bedKp 41.6808
  #define DEFAULT_bedKi 3.8113
  #define DEFAULT_bedKd 303.8810
...
// x and y should be false to enable sensorless homing
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // commented out for bltouch
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, -34, 0 }

// Ref: https://marlinfw.org/docs/gcode/M851
//#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.65
